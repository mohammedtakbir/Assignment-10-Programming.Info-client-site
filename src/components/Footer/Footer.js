                            ...
                            <div className="px-6">
                                ...
                                <div className="mt-6 lg:max-w-sm">
                                    <p className="text-sm text-gray-800">
                                        Get unlimited access to 7,000+ of Programming.info's top courses for your team. Learn and improve skills across business, tech, design, and more.
                                    </p>
                        ...
                        <div className="mt-6 lg:mt-0 lg:flex-1">
                            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                                <div>
                                    ...
                                    <Link to='/' className="block mt-2 text-sm text-gray-600 hover:underline">Python</Link>
                                    <Link to='/' className="block mt-2 text-sm text-gray-600 hover:underline">Java</Link>
                                    <Link to='/' className="block mt-2 text-sm text-gray-600 hover:underline">C</Link>
                                    <Link to='/' className="block mt-2 text-sm text-gray-600 hover:underline">C++</Link>
                                    <Link to='/' className="block mt-2 text-sm text-gray-600 hover:underline">Swift</Link>
                                    <Link to='/' className="block mt-2 text-sm text-gray-600 hover:underline">PHP</Link>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <Link to='/' className="block mt-2 text-sm text-gray-600 hover:underline">Upcoming Courses</Link>
                                    <Link to='/' className="block mt-2 text-sm text-gray-600 hover:underline">Top programming Language</Link>
                                    <Link to='/' className="block mt-2 text-sm text-gray-600 hover:underline">Technologies</Link>
                                </div>
                                <div>
